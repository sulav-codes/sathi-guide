    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-text-secondary mt-1">Review and approve new guide applications.</p>
        </div>
      ...
      <div className="bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center p-12 text-center">
            ...
            <h3 className="text-lg font-medium text-text">No pending guides</h3>
            <p className="text-text-secondary mt-1">All caught up! There are no guide applications waiting for review.</p>
          </div>
        ) : (
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                {filteredGuides.map((guide) => (
                  <tr key={guide.id} className="border-b border-border hover:bg-active-card/30 transition-colors group">
                    <td className="p-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          <p className="font-medium text-text">{guide.user?.email || 'Unknown User'}</p>
                          <p className="text-xs text-text-muted">ID: {guide.id.substring(0,8)}...</p>
                        </div>
                      </div>
                    </td>
                    <td className="p-4">
                    ...
                    <td className="p-4">
                      <div className="flex items-center justify-end space-x-2">
                        <button
                          ...
                          className="flex items-center px-3 py-1.5 bg-green/10 text-green hover:bg-green hover:text-white rounded-lg transition-colors text-sm font-medium"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center px-3 py-1.5 bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-white rounded-lg transition-colors text-sm font-medium"
                        >
