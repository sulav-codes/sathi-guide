...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-background bg-gradient-to-br from-background to-active-card relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 rounded-2xl bg-card border border-border shadow-2xl backdrop-blur-xl relative z-10 transition-all duration-300 hover:shadow-primary/10">
        <div className="text-center mb-10">
          <div className="w-16 h-16 overflow-hidden mx-auto flex items-center justify-center mb-4 transform transition-transform hover:scale-105">
            <Image
              src="/logo.png"
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="group">
            <label
              htmlFor="email"
              className="block text-sm font-medium text-text-muted mb-2 transition-colors group-focus-within:text-primary"
            >
              Email Address
            </label>
            <input
